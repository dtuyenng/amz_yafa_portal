      ...
      <div className="itemInfo">
        ...
        <div className="itemName">
          <p>
            ...
            quidem, atque nobis maxime fugit ab dignissimos officiis alias ipsam
            rem repellendus iusto animi cumque quos cupiditate sit eligendi
            consequatur fugiat.
          </p>
          <p>
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Labore,
            atque praesentium. Adipisci odio aliquam doloremque placeat. Officia
            laborum inventore ad perspiciatis fugiat. Laboriosam fuga asperiores
            perferendis molestiae unde, totam modi!
          </p>
        </div>
      </div>
    </div>
